...
public class NoticeService {
    ...
    //전체 공지사항리스트
    public List<HashMap<String,Object>> getNoticeList(int currentPage, int rowPerPage){
    ...
    //부서별 공지사항 리스트
    public List<HashMap<String,Object>> getAllDptNoticeList(int currentPage, int rowPerPage){
